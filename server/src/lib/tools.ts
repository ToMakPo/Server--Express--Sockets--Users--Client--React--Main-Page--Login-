...
export const evaluateTruthiness = (value: string): boolean | null | undefined => 
	/^(true|1|yes|y|on|correct|right|ok|okay|o)$/i.test(value) ? true : 
	/^(false|0|no|n|off|incorrect|wrong|not|x)$/i.test(value) ? false :
	/^(null|void|none|empty|blank|nothing|\?)$/i.test(value) ? null : 
	undefined;